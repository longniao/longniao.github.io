...
subtitle:   This is Simplelified Chinese Edition Document of Markdown Syntax.
date:       2014-09-29
author:     Longniao
header-img: img/post-markdown-table.png
catalog: true
tags:
    - Markdown
---
...
**声明：** 这份文档派生(fork)于[繁体中文版](http://markdown.tw/)，此文档用 Markdown 语法编写，你可以到这里[查看它的源文件][src_zhcn]。「繁体中文版的原始文件可以[查看这里][src_zhtw] 。」

  [src_zhcn]: https://raw.githubusercontent.com/longniao/longniao.github.com/master/_posts/2014-09-29-Markdown-Syntax-CN.markdown
  [src_zhtw]: https://github.com/othree/markdown-syntax-zhtw/blob/master/syntax.md
...
---
如有更好的 Markdown 免费编辑器推荐，请留言反馈，谢谢！
